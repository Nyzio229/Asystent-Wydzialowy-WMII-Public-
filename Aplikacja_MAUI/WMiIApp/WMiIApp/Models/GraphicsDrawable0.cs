...
{
    public class GraphicsDrawable0 : IDrawable
    {
        public void Draw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            {
                // Sprawdzamy, czy pokoj należy do poziomu 0
                if (room.Floor == 0)
                {
            ...
            // Sprawdzamy czy pokoj startowy nalezy do poziomu 0
            if (App.pathFinder.Path[0].Floor == 0)
            {
            ...
            // Sprawdzamy czy pokoj docelowy nalezy do poziomu 0
            if (App.pathFinder.Path[App.pathFinder.Path.Count() - 1].Floor == 0)
            {
